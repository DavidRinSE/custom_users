...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = MyUser
        fields = ('username', 'display_name', 'age', 'is_active', 'is_admin')
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('display_name', 'age', 'homepage')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('username', 'display_name', 'age', 'homepage', 'password1', 'password2')}
        ),
    )
